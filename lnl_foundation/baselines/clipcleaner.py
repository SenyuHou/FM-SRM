"""CLIPCleaner initial sample selection on FM-SRM's cached CLIP features.
...
def _metadata(dataset):
    filename = "clipcleaner_real_prompts.json" if dataset in {"animal10n", "webvision"} else "clipcleaner_prompts.json"
